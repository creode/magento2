<?php
namespace Rokanthemes\Categorytab\Model\Category\Attribute\Backend;

class Thumbnailimage extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
